...
%-------------------------------------------------------------------------------%
		\subsection{Polarization}
			...
			Polarization is useful since it allows for the separation of a beam based on this property without affecting its frequency (dispersion relation) or trajectory. This can be see in figure %(\ref{fig:setup})
...
\begin{figure} [!ht]
	\centering
	\def\svgwidth{\columnwidth}
	\resizebox{130mm}{!}{\input{images/cav-align-improper.pdf_tex}}
...
\begin{figure} [!ht]
	\centering
	\def\svgwidth{\columnwidth}
	\resizebox{130mm}{!}{\input{images/cav-align-proper.pdf_tex}}
...
\begin{figure} [!ht]
	\centering
	\def\svgwidth{\columnwidth}
	\resizebox{160mm}{!}{\input{images/mode-label.pdf_tex}}
